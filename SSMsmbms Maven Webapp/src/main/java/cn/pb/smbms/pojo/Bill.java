...
public class Bill {
	...
	private Integer providerId;// 供应商(providerID)
	...
	// private String userName;// 创建者名称 也是修改者名称
	...
	public Bill(Integer id, String billCode, String productName,
			...
			Integer providerId, Date creationDate, Integer modifyBy,
			Date modifyDate) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Bill [id=" + id + ", billCode=" + billCode + ", productName="
				...
				+ isPayment + ", createdBy=" + createdBy + ", providerId="
				+ providerId + ", creationDate=" + creationDate + ", modifyBy="
